...
- 客户端与服务端代码修改已经完成；绝对 UHID 绘图板指针和游戏触摸桥接使用 scrcpy v4.1 服务端已有协议，无需为鼠标功能修改服务端 APK。
- 补丁已验证能够干净应用到官方 scrcpy v4.1。
...
- 源码包中 QtScrcpyCore 的 `src/third_party/scrcpy-server` 仍是官方原版服务端；编译定制服务端后需要用生成的 APK 替换它。
